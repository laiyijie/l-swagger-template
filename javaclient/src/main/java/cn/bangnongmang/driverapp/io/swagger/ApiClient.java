package cn.bangnongmang.driverapp.io.swagger;
...
import cn.bangnongmang.driverapp.io.swagger.auth.HttpBasicAuth;
import cn.bangnongmang.driverapp.io.swagger.auth.ApiKeyAuth;
import cn.bangnongmang.driverapp.io.swagger.auth.OAuth;
import cn.bangnongmang.driverapp.io.swagger.auth.OAuth.AccessTokenListener;
import cn.bangnongmang.driverapp.io.swagger.auth.OAuthFlow;
...
public class ApiClient {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "http://work.laiyijie.me:36512/server/api/v1/";
    if(!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
