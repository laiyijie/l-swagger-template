 ...
 */
extern NSString *const BJDeserializationErrorDomainKey;

/**
 * Code for deserialization type mismatch error
 */
extern NSInteger const BJTypeMismatchErrorCode;

/**
 * Code for deserialization empty value error
 */
extern NSInteger const BJEmptyValueOccurredErrorCode;

/**
 * Error code for unknown response
 */
extern NSInteger const BJUnknownResponseObjectErrorCode;

@protocol BJResponseDeserializer <NSObject>
...
@interface BJResponseDeserializer : NSObject <BJResponseDeserializer>
