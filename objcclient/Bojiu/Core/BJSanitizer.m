...
NSString * const kBJApplicationJSONType = @"application/json";

NSString * BJPercentEscapedStringFromString(NSString *string) {
    static NSString * const kBJCharactersGeneralDelimitersToEncode = @":#[]@";
    static NSString * const kBJCharactersSubDelimitersToEncode = @"!$&'()*+,;=";

    NSMutableCharacterSet * allowedCharacterSet = [[NSCharacterSet URLQueryAllowedCharacterSet] mutableCopy];
    [allowedCharacterSet removeCharactersInString:[kBJCharactersGeneralDelimitersToEncode stringByAppendingString:kBJCharactersSubDelimitersToEncode]];
...
- (id) sanitizeForSerialization:(id) object {
    ...
    else if ([object isKindOfClass:[NSString class]] || [object isKindOfClass:[NSNumber class]] || [object isKindOfClass:[BJQueryParamCollection class]]) {
        return object;
    }
    ...
    else if ([object isKindOfClass:[BJObject class]]) {
