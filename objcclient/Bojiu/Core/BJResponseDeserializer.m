...
NSString *const BJDeserializationErrorDomainKey = @"BJDeserializationErrorDomainKey";

NSInteger const BJTypeMismatchErrorCode = 143553;

NSInteger const BJEmptyValueOccurredErrorCode = 143509;

NSInteger const BJUnknownResponseObjectErrorCode = 143528;


@interface BJResponseDeserializer ()
...
@implementation BJResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:BJDeserializationErrorDomainKey code:BJTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:BJDeserializationErrorDomainKey code:BJEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:BJDeserializationErrorDomainKey code:BJUnknownResponseObjectErrorCode userInfo:userInfo];
}
