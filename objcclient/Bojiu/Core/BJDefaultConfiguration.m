...
#import "BJBasicAuthTokenProvider.h"
#import "BJLogger.h"

@interface BJDefaultConfiguration ()
...
@implementation BJDefaultConfiguration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static BJDefaultConfiguration *shardConfig = nil;
...
- (instancetype) init {
    self = [super init];
    if (self) {
        _host = @"http://work.laiyijie.me:36512/server/api/v1/";
        _username = @"";
        _password = @"";
        _accessToken= @"";
        _verifySSL = YES;
...
- (NSString *) getBasicAuthToken {
    ...
    NSString *basicAuthToken = [BJBasicAuthTokenProvider createBasicAuthTokenWithUsername:self.username password:self.password];
